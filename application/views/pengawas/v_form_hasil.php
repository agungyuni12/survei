																...
																<tr>
																	...
																	<td>
																		<select name="TStpim[r211k3_1]" id="TStpim_r211k3_1" class="form-control select2">
																			...
																			<option value="<?php echo $row->number;?>" <?php if(@$arr_page3->r211k3_1 == $row->number){echo 'selected';}?>><?php echo $row->name;?></option>
																			<?php endforeach;?>
																		</select>
																	</td> 
																	<td>
																...
																<tr>
																	...
																	<td>
																		<select name="TStpim[r211k3_2]" id="TStpim_r211k3_2" class="form-control select2">
																			<?php foreach($country as $row):?>
																			<option value="<?php echo $row->number;?>" <?php if(@$arr_page3->r211k3_2 == $row->number){echo 'selected';}?>><?php echo $row->name;?></option>
																			<?php endforeach;?>
																		</select>
																	</td> 
																	<td>
												...
												<tr>
													...
													<td rowspan="1" style="width: 200px;">
														<select name="TStpim[b2r307k8]" id="r307_2_r307k8" class="form-control select2 vue-select select2-hidden-accessible" data-select2-id="r307_2_r307k8" tabindex="-1" aria-hidden="true">
															<?php foreach($country as $row):?>
															<option value="<?php echo $row->number;?>" <?php if(@$arr_page8->b2r307k8 == $row->number){echo 'selected';}?>><?php echo $row->name;?></option>
															<?php endforeach;?>
														</select>
													</td> 
													<!--td>
												...
												<tr>
													...
													<td rowspan="1" style="width: 200px;">
														<select name="TStpim[b3r307k8]" id="r307_3_r307k8" class="form-control select2 vue-select select2-hidden-accessible" data-select2-id="r307_3_r307k8" tabindex="-1" aria-hidden="true">
															<?php foreach($country as $row):?>
															<option value="<?php echo $row->number;?>" <?php if(@$arr_page8->b3r307k8 == $row->number){echo 'selected';}?>><?php echo $row->name;?></option>
															<?php endforeach;?>
														</select>
													</td> 
													<!--td>
												...
												<tr>
													...
													<td rowspan="1" style="width: 200px;">
														<select name="TStpim[b4r307k8]" id="r307_4_r307k8" class="form-control select2 vue-select select2-hidden-accessible" data-select2-id="r307_4_r307k8" tabindex="-1" aria-hidden="true">
															<?php foreach($country as $row):?>
															<option value="<?php echo $row->number;?>" <?php if(@$arr_page8->b4r307k8 == $row->number){echo 'selected';}?>><?php echo $row->name;?></option>
															<?php endforeach;?>
														</select>
													</td> 
													<!--td>
												...
												<tr>
													...
													<td rowspan="1" style="width: 200px;">
														<select name="TStpim[b5r307k8]" id="r307_5_r307k8" class="form-control select2 vue-select select2-hidden-accessible" data-select2-id="r307_5_r307k8" tabindex="-1" aria-hidden="true">
															<?php foreach($country as $row):?>
															<option value="<?php echo $row->number;?>" <?php if(@$arr_page8->b5r307k8 == $row->number){echo 'selected';}?>><?php echo $row->name;?></option>
															<?php endforeach;?>
														</select>
													</td> 
													<!--td>
												...
												<tr>
													...
													<td rowspan="1" style="width: 200px;">
														<select name="TStpim[b6r307k8]" id="r307_6_r307k8" class="form-control select2 vue-select select2-hidden-accessible" data-select2-id="r307_6_r307k8" tabindex="-1" aria-hidden="true">
															<?php foreach($country as $row):?>
															<option value="<?php echo $row->number;?>" <?php if(@$arr_page8->b6r307k8 == $row->number){echo 'selected';}?>><?php echo $row->name;?></option>
															<?php endforeach;?>
														</select>
													</td> 
													<!--td>
												...
												<tr>
													...
													<td rowspan="1" style="width: 200px;">
														<select name="TStpim[b7r307k8]" id="r307_7_r307k8" class="form-control select2 vue-select select2-hidden-accessible" data-select2-id="r307_7_r307k8" tabindex="-1" aria-hidden="true">
															<?php foreach($country as $row):?>
															<option value="<?php echo $row->number;?>" <?php if(@$arr_page8->b7r307k8 == $row->number){echo 'selected';}?>><?php echo $row->name;?></option>
															<?php endforeach;?>
														</select>
													</td> 
													<!--td>
												...
												<tr>
													...
													<td rowspan="1" style="width: 200px;">
														<select name="TStpim[b8r307k8]" id="r307_8_r307k8" class="form-control select2 vue-select select2-hidden-accessible" data-select2-id="r307_8_r307k8" tabindex="-1" aria-hidden="true">
															<?php foreach($country as $row):?>
															<option value="<?php echo $row->number;?>" <?php if(@$arr_page8->b8r307k8 == $row->number){echo 'selected';}?>><?php echo $row->name;?></option>
															<?php endforeach;?>
														</select>
													</td> 
													<!--td>
												...
												<tr>
													...
													<td rowspan="1">
														<select name="r402b[b2r402bk8]" id="r402b_2_r402bk8" class="form-control select2">
															<?php foreach($country as $row):?>
															<option value="<?php echo $row->number;?>" <?php if(@$arr_page9->b2r402bk8 == $row->number){echo 'selected';}?>><?php echo $row->name;?></option>
															<?php endforeach;?>
														</select>
													</td> 
													<!--td rowspan="2">
												...
												<tr>
													...
													<td rowspan="1">
														<select name="r402b[b3r402bk8]" id="r402b_3_r402bk8" class="form-control select2">
															<?php foreach($country as $row):?>
															<option value="<?php echo $row->number;?>" <?php if(@$arr_page9->b3r402bk8 == $row->number){echo 'selected';}?>><?php echo $row->name;?></option>
															<?php endforeach;?>
														</select>
													</td> 
													<!--td rowspan="2">
												...
												<tr>
													...
													<td rowspan="1">
														<select name="r402b[b4r402bk8]" id="r402b_4_r402bk8" class="form-control select2">
															<?php foreach($country as $row):?>
															<option value="<?php echo $row->number;?>" <?php if(@$arr_page9->b4r402bk8 == $row->number){echo 'selected';}?>><?php echo $row->name;?></option>
															<?php endforeach;?>
														</select>
													</td> 
													<!--td rowspan="2">
												...
												<tr>
													...
													<td rowspan="1">
														<select name="r402b[b5r402bk8]" id="r402b_5_r402bk8" class="form-control select2">
															<?php foreach($country as $row):?>
															<option value="<?php echo $row->number;?>" <?php if(@$arr_page9->b5r402bk8 == $row->number){echo 'selected';}?>><?php echo $row->name;?></option>
															<?php endforeach;?>
														</select>
													</td> 
													<!--td rowspan="2">
												...
												<tr>
													...
													<td rowspan="1">
														<select name="r402b[b6r402bk8]" id="r402b_6_r402bk8" class="form-control select2">
															<?php foreach($country as $row):?>
															<option value="<?php echo $row->number;?>" <?php if(@$arr_page9->b6r402bk8 == $row->number){echo 'selected';}?>><?php echo $row->name;?></option>
															<?php endforeach;?>
														</select>
													</td> 
													<!--td rowspan="2">
												...
												<tr>
													...
													<td rowspan="1">
														<select name="r402b[b7r402bk8]" id="r402b_7_r402bk8" class="form-control select2">
															<?php foreach($country as $row):?>
															<option value="<?php echo $row->number;?>" <?php if(@$arr_page9->b7r402bk8 == $row->number){echo 'selected';}?>><?php echo $row->name;?></option>
															<?php endforeach;?>
														</select>
													</td> 
													<!--td rowspan="2">
